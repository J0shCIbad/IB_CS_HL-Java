    ...
    public void testDataCollection()
    {
        ...
        for (int m = 0; m < 100; m++)
        {
            ...
            for (int k = 0; k < 3; k++)
            {
                ...
                System.out.println(temp + "->" + aNum);
                System.out.println(checkSamePlace(aNum, temp, ""+nextInt));
            ...
            for (int k = 0; k < 3; k++)
            {
                ...
                System.out.println(temp + "->" + bNum);
                System.out.println(checkSamePlace(bNum, temp, ""+nextInt));
            ...
            for (int k = 0; k < 5; k++)
            {
                ...
                System.out.println(temp + "->" + cNum);
                System.out.println(checkSamePlace(cNum, temp, ""+nextInt));
